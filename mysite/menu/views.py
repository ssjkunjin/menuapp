...
from menu.models import Profile, Recipe, Ingredient, RecipeIngredient
...
class RecipeCreate(View):
    ...
    def get(self, request, *args, **kwargs):
        ...
        formset = self.RecipeIngredientFormSet()
...
class RecipeUpdate(View):
    ...
    success_url = reverse_lazy('menu:recipe_list')
    RecipeForm = modelform_factory(Recipe, fields=('name', 'private','rating','directions'))
    RecipeIngredientFormSet = modelformset_factory(RecipeIngredient, fields=('amount','unit','ingredient'), extra=1)
